...
document.getElementById("nodo-principal").addEventListener("click", function() {
    ...
    if (nodos.length === 0) {
        ...
        const elementos = [
            { texto: "1", icono: "", link: ".html"},
            { texto: "2", icono: "", link: ".html"},
            { texto: "3", icono: "", link: ".html"},
            { texto: "4", icono: "", link: ".html"},
            { texto: "4", icono: "", link: ".html"},
            { texto: "5", icono: "", link: ".html"},
            { texto: "6", icono: "", link: ".html"},
            { texto: "7", icono: "", link: ".html"},
            { texto: "8", icono: "", link: ".html"},
            { texto: "9", icono: "", link: ".html"}
        ];
